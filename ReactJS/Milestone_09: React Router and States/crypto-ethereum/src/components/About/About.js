  ...
  return (
    <section class='px-4 pt-20 pb-24 mx-auto max-w-7xl md:px-2'>
      <div class='grid grid-cols-1 gap-24 md:grid-cols-2'>
        <div>
          <h1 class='mb-6 text-2xl font-light text-gray-900 md:text-3xl bg-slate-200 rounded-lg'>
            Basic Questions
          </h1>
          <p class='mt-10 mb-3 font-semibold text-gray-900'>
            What is accessibility?
          </p>
          <p class='text-gray-600 border-l-4 pl-3'>
        ...
        <div >
          <h1 class='mb-6 text-2xl font-light md:text-3xl bg-slate-200 rounded-lg'>
            Advanced Questions
          </h1>
          <p class='mt-10 mb-3 font-semibold text-gray-900 '>
