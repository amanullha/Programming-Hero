...
10. useSingInWithEmailAndPassword for sing in
11.Create RequireAuth Component ==> check exists also tract user information 
...
/**
 Firebase Hosting Steps
    ...
    1. -> npm install -g firebase-tools  or -> sudo npm install -g firebase-tools --unsafe-perm (one Time for computer)

    2. firebase login(one time for your computer)
    3. firebase init(one time for your project)
    4. ->npm run build(every time you want to deploy)
    4. firebase deploy(every time you want to deploy)
